    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">اضافة عرض</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form" action="{{ route('offers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <select class="form-control" aria-invalid="false" name="service_type">
                                        ...
                                        <option value="1" {{ old('service_type') == 1 ? 'selected' : '' }}>غسيل</option>
                                        <option value="2" {{ old('service_type') == 2 ? 'selected' : '' }}>مواقف</option>
                                    </select>
                                    @error('service_type')
                                    <span class="text-danger" id="basic-default-name-error" class="error">
                                        {{ $message }}
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="text" class="form-control" placeholder="اسم العرض" name="title" value="{{ old('title') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="file" class="form-control" placeholder="العدد - صوره" name="count_image" value="{{ old('count_image') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="number" class="form-control" placeholder="عدد مرات الاستخدام" name="count" value="{{ old('count') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="number" step="0.001" class="form-control" placeholder="سعر الوحده" name="unit_price" value="{{ old('unit_price') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="number" step="0.001" class="form-control" placeholder="قيمه العرض" name="amount" value="{{ old('amount') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <textarea class="form-control" placeholder="التفاصيل" name="details">{{ old('details') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <select class="form-control" aria-invalid="false" name="is_open_for_use">
                                        ...
                                        <option value="0" {{ old('is_open_for_use') == 0 ? 'selected' : '' }}>مفتوح</option>
                                        <option value="1" {{ old('is_open_for_use') == 1 ? 'selected' : '' }}>مقيد</option>
                                    </select>
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="number" class="form-control" placeholder="مده الاستخدام (يوم)" name="duration" value="{{ old('duration') }}">
