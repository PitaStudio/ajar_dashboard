    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">اضافة هديه</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form" action="{{ route('gifts.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-label-group">
                                    <input type="number" step="0.001" class="form-control" placeholder="الرصيد" name="palance" value="{{ old('palance') }}">
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                    <textarea class="form-control" placeholder="الرساله" name="message">{{ old('message') }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                    <input type="number" class="form-control" placeholder="الهاتف" name="phone" value="{{ old('phone') }}">
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                    <input type="text" class="form-control" placeholder="كود" name="code" value="{{ old('code') }}">
