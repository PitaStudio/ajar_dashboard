    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">اضافة مزود خدمه</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="form" action="{{ route('providers.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="unmber" class="form-control" placeholder="الهاتف" name="phone" value="{{ old('phone') }}">
                            ...
                            <div class="col-12">
                                <div class="form-label-group">
                                    <textarea class="form-control" placeholder="العنوان" name="address">{{ old('address') }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="unmber" step="0.00000000000000001" class="form-control" placeholder="خط الطول" name="lon" value="{{ old('lon') }}">
                            ...
                            <div class="col-6">
                                <div class="form-label-group">
                                    <input type="unmber" step="0.00000000000000001" class="form-control" placeholder="خط العرض" name="lat" value="{{ old('lat') }}">
